...
async function main() {
    ...
    const movieActorData = [
        // Inception
        {
            ...
            actor_first_name: 'Leonardo',
            actor_last_name: 'DiCaprio',
        },
        {
            movie_title: 'Inception',
            actor_first_name: 'Marion',
            actor_last_name: 'Cotillard',
        },
        ...
        // The Dark Knight
        {
            ...
            actor_last_name: 'Bale',
        },
        {
            movie_title: 'The Dark Knight',
            actor_first_name: 'Heath',
            actor_last_name: 'Ledger',
        },

        // Interstellar
        {
            movie_title: 'Interstellar',
            actor_first_name: 'Matthew',
            actor_last_name: 'McConaughey',
        },
        {
            movie_title: 'Interstellar',
            actor_first_name: 'Anne',
            actor_last_name: 'Hathaway',
        },

        // Jurassic Park
        {
            movie_title: 'Jurassic Park',
            actor_first_name: 'Sam',
            actor_last_name: 'Neill',
        },
        {
            movie_title: 'Jurassic Park',
            actor_first_name: 'Laura',
            actor_last_name: 'Dern',
        },

        // Schindler's List
        {
            movie_title: "Schindler's List",
            actor_first_name: 'Liam',
            actor_last_name: 'Neeson',
        },
        {
            movie_title: "Schindler's List",
            actor_first_name: 'Ben',
            actor_last_name: 'Kingsley',
        },
        ...
        // Pulp Fiction
        {
            ...
            actor_last_name: 'Travolta',
        },
        {
            movie_title: 'Pulp Fiction',
            actor_first_name: 'Uma',
            actor_last_name: 'Thurman',
        },

        // Django Unchained
        {
            movie_title: 'Django Unchained',
            actor_first_name: 'Jamie',
            actor_last_name: 'Foxx',
        },
        {
            movie_title: 'Django Unchained',
            actor_first_name: 'Christoph',
            actor_last_name: 'Waltz',
        },
        ...
        // Goodfellas
        {
            ...
            actor_last_name: 'De Niro',
        },
        {
            movie_title: 'Goodfellas',
            actor_first_name: 'Ray',
            actor_last_name: 'Liotta',
        },
        ...
        // Blade Runner 2049
        {
            ...
            actor_first_name: 'Ryan',
            actor_last_name: 'Gosling',
        },
        {
            movie_title: 'Blade Runner 2049',
            actor_first_name: 'Harrison',
            actor_last_name: 'Ford',
        },

        // Dune
        {
            movie_title: 'Dune',
            actor_first_name: 'Timothée',
            actor_last_name: 'Chalamet',
        },
        {
            movie_title: 'Dune',
            actor_first_name: 'Zendaya',
            actor_last_name: 'Coleman',
        },

        // Get Out
        {
            movie_title: 'Get Out',
            actor_first_name: 'Daniel',
            actor_last_name: 'Kaluuya',
        },
        {
            movie_title: 'Get Out',
            actor_first_name: 'Allison',
            actor_last_name: 'Williams',
        },

        // Us
        {
            movie_title: 'Us',
            actor_first_name: 'Lupita',
            actor_last_name: "Nyong'o",
        },
        ...
        // Parasite
        {
            ...
            actor_first_name: 'Song',
            actor_last_name: 'Kang-ho',
        },
        {
            movie_title: 'Parasite',
            actor_first_name: 'Lee',
            actor_last_name: 'Sun-kyun',
        },

        // Pan's Labyrinth
        {
            movie_title: "Pan's Labyrinth",
            actor_first_name: 'Ivana',
            actor_last_name: 'Baquero',
        },
        {
            movie_title: "Pan's Labyrinth",
            actor_first_name: 'Sergi',
        ...
        // The Shape of Water
        {
            ...
            actor_first_name: 'Sally',
            actor_last_name: 'Hawkins',
        },
        {
            movie_title: 'The Shape of Water',
            actor_first_name: 'Michael',
            actor_last_name: 'Shannon',
        },

        // Fight Club
        {
            movie_title: 'Fight Club',
            actor_first_name: 'Brad',
            actor_last_name: 'Pitt',
        },
        {
            movie_title: 'Fight Club',
            actor_first_name: 'Edward',
            actor_last_name: 'Norton',
        },

        // The Social Network
        {
            movie_title: 'The Social Network',
            actor_first_name: 'Jesse',
            actor_last_name: 'Eisenberg',
        },
        {
            movie_title: 'The Social Network',
            actor_first_name: 'Andrew',
            actor_last_name: 'Garfield',
        },

        // Lady Bird
        {
            movie_title: 'Lady Bird',
            actor_first_name: 'Saoirse',
            actor_last_name: 'Ronan',
        },
        {
            movie_title: 'Lady Bird',
            actor_first_name: 'Laurie',
            actor_last_name: 'Metcalf',
        },

        // Barbie
        {
            movie_title: 'Barbie',
            actor_first_name: 'Margot',
            actor_last_name: 'Robbie',
        },
        {
            movie_title: 'Barbie',
            actor_first_name: 'Ryan',
            actor_last_name: 'Reynolds',
        },
    ];
    ...
    for (const relationData of movieActorData) {
        ...
        const actor = actors.find(a => a.first_name === relationData.actor_first_name && a.last_name === relationData.actor_last_name);
